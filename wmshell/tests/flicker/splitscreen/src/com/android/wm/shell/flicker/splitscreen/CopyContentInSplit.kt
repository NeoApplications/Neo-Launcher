...
class CopyContentInSplit(override val flicker: LegacyFlickerTest) :
    ...
    @Presubmit
    @Test
    fun primaryAppLayerKeepVisible() = flicker.layerKeepVisible(primaryApp)

    @Presubmit
    @Test
    fun textEditAppLayerKeepVisible() = flicker.layerKeepVisible(textEditApp)
    ...
    @Presubmit
    @Test
    fun textEditAppWindowKeepVisible() = flicker.appWindowKeepVisible(textEditApp)
