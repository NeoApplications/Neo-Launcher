...
The core WMShell library code is currently located in
the [frameworks/base/libs/WindowManager/Shell](/libs/WindowManager/Shell)
...
various targets can be found in the Shell
library's [Android.bp](/libs/WindowManager/Shell/Android.bp)
file.
