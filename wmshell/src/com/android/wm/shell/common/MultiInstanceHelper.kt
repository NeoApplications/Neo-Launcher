...
class MultiInstanceHelper @JvmOverloads constructor(
    ...
    fun supportsMultiInstanceSplit(componentName: ComponentName?): Boolean {
        ...
        for (pkg in staticAppsSupportingMultiInstance) {
            if (pkg == packageName) {
                KtProtoLog.v(
                    WM_SHELL, "application=%s in allowlist supports multi-instance",
                    packageName
                )
                return true
            }
        ...
        try {
            ...
            if (activityProp.isBoolean) {
                ...
                KtProtoLog.w(
                    WM_SHELL, "Warning: property=%s for activity=%s has non-bool type=%d",
    ...
    companion object {
        ...
        fun getShortcutComponent(
            packageName: String, shortcutId: String,
            user: UserHandle, launcherApps: LauncherApps
        ): ComponentName? {
        ...
        @JvmStatic
        fun samePackage(
            packageName1: String?, packageName2: String?,
