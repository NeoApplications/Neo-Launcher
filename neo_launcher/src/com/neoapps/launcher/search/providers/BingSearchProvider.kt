...
package com.neoapps.launcher.search.providers
...
import com.neoapps.launcher.search.AbstractSearchProvider
import com.neoapps.launcher.util.isAppEnabled

@Keep
class BingSearchProvider(context: Context) : AbstractSearchProvider(context) {
    ...
    private val copilotInstalled: Boolean
        get() = context.packageManager.isAppEnabled(PACKAGE_ALEXA, 0)
    ...
    companion object {
        ...
        private const val PACKAGE_COPILOT = "com.microsoft.copilot"
    }
}
