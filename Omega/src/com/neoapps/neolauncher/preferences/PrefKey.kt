...
object PrefKey {
    ...
    val PROFILE_POPUP_OPTIONS = stringSetPreferencesKey("profile_popup_options")
    ...
    val DESKTOP_DEFAULT_PAGE = intPreferencesKey("desktop_default_page")
    ...
    val DESKTOP_EMPTY_SCREENS_IDS = stringPreferencesKey("desktop_empty_screen_ids")
    ...
    val DRAWER_ENABLE_FOLDERS = booleanPreferencesKey("drawer_enable_folders")
    ...
    val GESTURES_PINCH_IN = stringPreferencesKey("gesture_pinch_in")
    val GESTURES_PINCH_OUT = stringPreferencesKey("gesture_pinch_out")
