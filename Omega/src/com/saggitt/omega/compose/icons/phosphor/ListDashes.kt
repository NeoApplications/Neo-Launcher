package com.saggitt.omega.compose.icons.phosphor
...
val Phosphor.ListDashes: ImageVector
    get() {
        if (_list_dashes != null) {
            return _list_dashes!!
        }
        _list_dashes = Builder(
            name = "List-dashes",
...
private var _list_dashes: ImageVector? = null
