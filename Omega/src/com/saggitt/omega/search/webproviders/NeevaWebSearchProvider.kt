...
class NeevaWebSearchProvider(context: Context) : WebSearchProvider(context) {
    override val iconRes: Int
        get() = R.drawable.ic_neeva
    override val icon: Drawable
        get() = ResourcesCompat.getDrawable(context.resources, iconRes, null)!!

    override val packageName: String
        get() = "https://neeva.com/search?q=%s"

    override val suggestionsUrl: String?
        get() = null

    override val displayName: String
        get() = context.getString(R.string.web_search_neeva)
}