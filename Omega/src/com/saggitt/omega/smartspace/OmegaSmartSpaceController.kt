...
class OmegaSmartSpaceController(val context: Context) {
            ...
            provider.startSetup { success ->
                if (success) {
                    ...
                    if (weatherDataProvider == provider) {
                        weatherProviderPref.setValue(BlankDataProvider::class.java.name)
                    }
    ...
    fun onProviderChanged() {
        val weatherClass = weatherProviderPref.getValue()
        ...
        weatherProviderPref.setValue(weatherDataProvider::class.java.name)
