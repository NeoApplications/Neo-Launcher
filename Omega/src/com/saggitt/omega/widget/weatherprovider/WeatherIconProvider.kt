...
class WeatherIconProvider(private val context: Context) {
    ...
    companion object {
        ...
        private const val CONDITION_CLEAR = "01"
        private const val CONDITION_FEW_CLOUDS = "02"
        private const val CONDITION_CLOUDS = "03"
        private const val CONDITION_MOST_CLOUDS = "04"
        private const val CONDITION_SHOWERS = "09"
        private const val CONDITION_RAIN = "10"
        private const val CONDITION_STORM = "11"
        private const val CONDITION_SNOW = "13"
        private const val CONDITION_MIST = "50"
        ...
        private val ID_MAP = mapOf(
            ...
            "${CONDITION_MOST_CLOUDS}n" to R.drawable.weather_04,
            ...
            CONDITION_UNKNOWN to R.drawable.ic_arrow_clockwise
        )
    }
}