...
import com.saggitt.omega.widget.PeriodicDataProvider
import com.saggitt.omega.widget.Temperature

@Keep
class PEWeatherDataProvider(context: Context) :
    PeriodicDataProvider(context) {
    ...
    override fun queryWeatherData(): WeatherData? {
    ...
    private fun getConditionIcon(condition: String): Bitmap {
        ...
        // TODO consider simplifying using BitmapFactory.decodeResource
