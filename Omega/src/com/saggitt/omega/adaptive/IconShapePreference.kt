...
>>>>>>> ba3d8f4607d1f35bce071eabb638c4e819bb5fbc
    ...
    override fun onAttached() {
        super.onAttached()
        context.omegaPrefs.addOnPreferenceChangeListener("pref_iconShape", this)
    }

    override fun onDetached() {
        super.onDetached()
        context.omegaPrefs.removeOnPreferenceChangeListener("pref_iconShape", this)
    }
    ...
    class CustomizeDialogFragment : PreferenceDialogFragmentCompat() {
        ...
        override fun onDialogClosed(positiveResult: Boolean) {
            if (positiveResult) {
                IconShapeManager.getInstance(requireContext()).iconShape = customizeView.currentShape
            }
        }
