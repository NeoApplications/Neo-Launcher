...
class BlurQsbLayout @JvmOverloads constructor(
    ...
    private val mMicWidth = resources.getDimensionPixelSize(R.dimen.qsb_mic_width)
    ...
    override fun onAttachedToWindow() {
        ...
        context.omegaPrefs.addOnPreferenceChangeListener("pref_searchbarRadius", this)
        blurDrawable?.startListening()
    }

    override fun onDetachedFromWindow() {
        super.onDetachedFromWindow()
        context.omegaPrefs.removeOnPreferenceChangeListener("pref_searchbarRadius", this)
